...
var IDBObject = /** @class */ (function () {
    function IDBObject(db, _a, dbVersionController) {
        ...
        this.put = function (key, value) { return __awaiter(_this, void 0, void 0, function () {
            var _a, db, dbVersionController, storeName, closeDBConnection, idbdb, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        err_1 = _b.sent();
                        console.error(typings_1.IDBORM + ": " + storeName + ".put(" + key + ") " + err_1);
        ...
        this.get = function (key) { return __awaiter(_this, void 0, void 0, function () {
            var _a, db, dbVersionController, closeDBConnection, idbdb, value, err_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, idb_1.openDB(this.db.name, dbVersionController.incDbVersion(), {
                                blocked: function () {
                                    closeDBConnection();
                                },
                            })];
                    case 2:
                        idbdb = _b.sent();
                        return [4 /*yield*/, idbdb.get(this.storeName, key)];
                    case 3:
                        value = _b.sent();
                        idbdb.close();
                        return [2 /*return*/, value];
        ...
        this.delete = function (key) { return __awaiter(_this, void 0, void 0, function () {
            var closeDBConnection, idbdb, err_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        idbdb = _a.sent();
                        return [4 /*yield*/, idbdb.delete(this.storeName, key)];
                    case 3:
                        _a.sent();
                        idbdb.close();
                        return [3 /*break*/, 5];
        ...
        this.clear = function () { return __awaiter(_this, void 0, void 0, function () {
            var closeDBConnection, idbdb, err_7;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
