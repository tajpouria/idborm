...
var IDB = /** @class */ (function () {
    function IDB(dbName, db, objectStoresMap) {
        var _this = this;
        ...
        this.delete = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, idb_1.deleteDB(this.dbName, {
                        blocked: function () {
                            closeDBConnection();
                        },
                    })];
    ...
    IDB.init = function (dataBaseName, objectStores) { return __awaiter(void 0, void 0, void 0, function () {
        var objectStoresList;
        return __generator(this, function (_a) {
            if (!dataBaseName) {
                console.error(typings_1.IDBErrors.noDatabaseName);
                throw new Error(typings_1.IDBErrors.noDatabaseName);
            }
            else if (!objectStores || (Array.isArray(objectStores) && !objectStores.length)) {
                console.error(typings_1.IDBErrors.noObjectStore);
                throw new Error(typings_1.IDBErrors.noObjectStore);
            }
            objectStoresList = Array.isArray(objectStores) ? objectStores : [objectStores];
            return [2 /*return*/, (function identifyDB(version) {
                    return __awaiter(this, void 0, void 0, function () {
                        var objectStoresMap, idbdb, _error_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    objectStoresMap = {};
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    return [4 /*yield*/, idb_1.openDB(dataBaseName, version, {
                                            upgrade: function (db) {
                                                objectStoresList.forEach(function (os) {
                                                    if (!db.objectStoreNames.contains(os.name)) {
                                                        db.createObjectStore(os.name, os.options || { autoIncrement: true });
                                                    }
                                                    objectStoresMap[os.name] = new IDBObject_1.IDBObject(db, os.name);
                                                });
                                            },
                                            blocking: function () {
                                ...
                                case 2:
                                    idbdb = _a.sent();
                                    return [2 /*return*/, new IDB(dataBaseName, idbdb, objectStoresMap)];
                                case 3:
                                    _error_1 = _a.sent();
                                    console.log(_error_1);
                                    debugger;
                                    return [2 /*return*/, identifyDB(version + 1)];
